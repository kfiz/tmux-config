{ pkgs, ... }:
{
  config = {
    ...
    xdg = {
      enable = true;
      configFile."tmux-powerline/config.sh".text = ''
        ...
        # macos_notification_count.sh {
                ...
                # sqlite3 -list "/var/folders/vj/cm0c8jrs739_t411zdcx72240000gp/0//com.apple.notificationcenter/db/db" 'select * from app_info'
        ...
        # mailcount.sh {
                ...
                export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/louis/.mail/inbox/new"
                ...
                export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/louis/.mailcheckrc"
        # }
        ...
        # weather.sh {
                ...
                TMUX_POWERLINE_SEG_WEATHER_LAT="48.1"
                TMUX_POWERLINE_SEG_WEATHER_LON="11.6"
        # }
      '';
    };
  };
